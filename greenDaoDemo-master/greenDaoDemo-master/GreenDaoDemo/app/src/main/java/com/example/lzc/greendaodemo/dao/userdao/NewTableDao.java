...
*/
public class NewTableDao extends AbstractDao<NewTable, Long> {
    ...
    */
    ...
    @Override
    protected final Long updateKeyAfterInsert(NewTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(NewTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
